...
def main ():
    ...
    while res != "q":
        res = input("Skriv inn ukedag og stasjon separert med komma (,) uten mellomrom: ")
        ...
        if(x == None):
            print("Datoen er ikke på riktig format (yyyy-mm-dd)")
            continue
...
main()
# print(getTrainsPerDayPerStation("Trondheim", "2023-04-03"))